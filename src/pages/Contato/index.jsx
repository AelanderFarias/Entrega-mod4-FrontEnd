...
export default function Contato() {
    ...
    const salvarViagem = async (e) => {
        ...
        await axios.post("http://localhost:8080/api/viagens", {
            destino: destino,
            partida: partida,
        ...
        <div>
            ...
            <div className="container">
                <div className="form">
                    ...
                    <button className="btn btn-primary" onClick={salvar}>Enviar</button>
                ...
                <div className="form">
                    <label for="formControlInput" className="form-label">Destino </label>
                    <input className="form-control" type="text" placeholder="Destino" value={destino}  onChange={(e) => setDestino(e.target.value)} />
                    <br />
                    <label for="formControlInput" className="form-label">Partida </label>
                    <input className="form-control" type="text" placeholder="Partida" value={partida}  onChange={(e) => setPartida(e.target.value)}  />
                    <br />
                    <label for="FormControlInput" className="form-label">Transporte</label>
                    <input type="text" className="form-control" placeholder="Transporte" value={transporte}  onChange={(e) => setTransporte(e.target.value)} />
                    <br />
                    <label for="FormControlInput" className="form-label">Valor</label>
                    <input type="text" className="form-control" placeholder="Valor da Viagem" value={valor}  onChange={(e) => setValor(e.target.value)} />
                    <br />
                    
                    <button className="btn btn-primary" onClick={salvarViagem}>Salvar Minha Viagem</button>

                </div>
            </div>
                <hr />
            </div>
            <div><h4>Lista de Clientes</h4></div>
            <table className="table table-striped border shadow">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>{cliente.email}</th>
                        <th>
                            <button className="btn btn-outline-success mx-2">Ver</button>
            ...
            <div><h4>Lista de Viagens</h4></div>
            <table className="table table-striped border shadow">
                <thead>
                    <tr>
                        <th scope="col">#</th>
